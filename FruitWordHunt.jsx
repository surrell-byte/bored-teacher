...
/**
 * FruitWordHunt
 * Auto-converted from fruit-word-hunt.html into a self-contained React component.
 ...
 * HTML page). 
 */
const FruitWordHunt_HTML = `<div id="correctPopup" class="popup"></div>
...
// ---------- FRUIT DATABASE (only real fruit emojis, no placeholders) ----------
  ...
  return (
    <>
      <style>{FruitWordHunt_CSS}</style>
      <div
        ref={containerRef}
        className="fruitwordhunt-root"
        dangerouslySetInnerHTML={{ __html: FruitWordHunt_HTML }}
      />
    </>
  );
}
