...
export default function ProfilePage() {
  ...
  return <main className="profile-page hub-page">
    ...
    {isGuest && <section className="shell-card" style={{ marginBottom: 20 }}><h2>Sign in to edit your profile</h2><p>Create an account or sign in to save your name, username, theme, and avatar.</p><button type="button" className="btn-primary" onClick={() => router.push('/auth?returnTo=/profile')}>Create account / Sign in</button></section>}
