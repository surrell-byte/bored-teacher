...
const RESOURCES: Resource[] = [
  ...
  // Blog Sections
  { id: 'b1', icon: '📚', title: 'Getting Started as an ESL Teacher', desc: '10 essential guides for new teachers—from planning your first lesson to building confidence and managing common challenges.', type: 'guide', subject: 'English', dateAdded: '2026-08-19' },
  { id: 'b2', icon: '📖', title: 'Lesson Planning & Teaching Methodology', desc: '20 in-depth guides covering lesson structure, grammar teaching, vocabulary, speaking, listening, reading, writing, and pronunciation techniques.', type: 'guide', subject: 'English', dateAdded: '2026-08-19' },
  { id: 'b3', icon: '👥', title: 'Classroom Management', desc: '17 practical strategies for establishing rules, handling disruptions, managing mixed-level classes, and resolving conflicts effectively.', type: 'guide', subject: 'English', dateAdded: '2026-08-19' },
  { id: 'b4', icon: '🎓', title: 'Teaching Different Students', desc: '14 guides for adapting your teaching to different ages, proficiency levels, abilities, and learning styles.', type: 'guide', subject: 'English', dateAdded: '2026-08-19' },
  { id: 'b5', icon: '📊', title: 'Assessment & Student Progress', desc: '15 guides on assessing skills, giving feedback, correcting errors, grading fairly, and tracking student improvement.', type: 'guide', subject: 'English', dateAdded: '2026-08-19' },
  { id: 'b6', icon: '✨', title: 'Teaching English Effectively', desc: '14 advanced guides on language acquisition principles, fluency vs. accuracy, student motivation, and teaching for communication.', type: 'guide', subject: 'English', dateAdded: '2026-08-19' },
  { id: 'b7', icon: '💻', title: 'Technology & Modern ESL Teaching', desc: '15 guides on using AI, digital tools, online teaching, interactive activities, and integrating technology without distraction.', type: 'guide', subject: 'English', dateAdded: '2026-08-19' },
  { id: 'b8', icon: '🏆', title: 'Professional Development', desc: '15 guides on certifications, improving skills, finding mentors, staying current with trends, and building teaching expertise.', type: 'guide', subject: 'English', dateAdded: '2026-08-19' },
  { id: 'b9', icon: '💰', title: 'Career & Money', desc: '20 guides on finding ESL jobs, salary negotiation, starting a tutoring business, maximizing income, and teaching while traveling.', type: 'guide', subject: 'English', dateAdded: '2026-08-19' },
  { id: 'b10', icon: '🚀', title: 'Advanced Teaching & Teacher Leadership', desc: '14 guides on curriculum development, training other teachers, leading programs, and contributing to the ESL teaching community.', type: 'guide', subject: 'English', dateAdded: '2026-08-19' },
  { id: 'b11', icon: '❤️', title: 'The Human Side of Teaching', desc: '12 guides on building rapport, managing emotions, avoiding burnout, setting boundaries, and sustaining passion for teaching.', type: 'guide', subject: 'English', dateAdded: '2026-08-19' },
  { id: 'b12', icon: '🎯', title: 'Practical "Teacher Survival" Posts', desc: '14 quick tips and hacks for daily teaching challenges—emergency activities, recovering from lesson failures, and surviving difficult days.', type: 'guide', subject: 'English', dateAdded: '2026-08-19' },
];
