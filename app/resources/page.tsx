...
const RESOURCES: Resource[] = [
  ...
  { id: 'w2', icon: '📄', title: 'Farm Animal Vocabulary Sheet',          desc: 'Pre-teach vocabulary before students play Farm Game.',                                          tag: 'Worksheet', tagColor: 'tag-vocab',   type: 'worksheet' },
