  ...
  return (
    <div className="shop-page">
      ...
      <section className="shell-card shop-payment">
        <div><div className="hero-kicker">💳 Support the Hub</div><h2>Pay securely with Paynow</h2><p>Use the payment link to complete your purchase.</p></div>
        <a href="https://www.paynow.co.zw/Payment/Link/?q=c2VhcmNoPXJ1c3NlbGxta2FoYW5hbmElNDBnbWFpbC5jb20mYW1vdW50PTcuMDAmcmVmZXJlbmNlPSZsPTE%3d" target="_blank" rel="noreferrer"><img src="https://www.paynow.co.zw/Content/Buttons/Medium_buttons/button_pay-now_medium.png" alt="Pay now with Paynow" style={{ border: 0 }} /></a>
      </section>
      <div className="shop-filter-row" role="group" aria-label="Shop category">
      ...
      <p className="shop-note">Purchased avatars and themes can be managed anytime from your profile menu.</p>
    </div>
  );
}
