...
.hidden-colours{min-height:100vh;display:grid;place-items:center;padding:clamp(8px,2vw,16px);background:linear-gradient(180deg,#111317,#0c0d10);color:#fff;font-family:Inter,var(--font-body),sans-serif;overflow:hidden}.hidden-colours *{box-sizing:border-box}.hidden-colours__shell{display:grid;grid-template-columns:1fr 260px;gap:16px;width:min(1100px,98vw);height:calc(100vh - 32px);padding:14px;background:#17171c;border:1px solid #2d2d35;border-radius:28px;box-shadow:0 30px 60px rgba(0,0,0,.45)}.hidden-colours__left{display:flex;flex-direction:column;min-width:0;gap:12px}.hidden-colours__progress-area{flex-shrink:0}.hidden-colours__progress-top{display:flex;justify-content:space-between;gap:8px;color:#8f8f99;font-size:.75rem;margin-bottom:6px}.hidden-colours__progress-top span:last-child{text-align:right}.hidden-colours__progress-bar{height:6px;background:#27272f;border-radius:100px;overflow:hidden}.hidden-colours__progress-bar>div{height:100%;background:linear-gradient(90deg,#e6c467,#ffd87d);transition:width .4s}.hidden-colours__grid-wrapper{flex:1;display:grid;place-items:center;min-height:0}.hidden-colours__grid{width:min(100%,600px);display:grid;grid-template-columns:repeat(5,1fr);gap:10px;aspect-ratio:1}.hidden-colours__tile{aspect-ratio:1;border:0;border-radius:16px;background:#e5c469;color:#fff;font-size:1.5rem;font-weight:700;display:flex;justify-content:center;align-items:center;box-shadow:inset 0 2px 4px rgba(255,255,255,.35),0 10px 18px rgba(0,0,0,.25);transition:.2s;cursor:pointer}.hidden-colours__tile:hover:not(.is-revealed){transform:translateY(-3px);box-shadow:inset 0 2px 4px rgba(255,255,255,.35),0 14px 24px rgba(0,0,0,.35)}.hidden-colours__tile.is-revealed{background:#29292f;cursor:default}.hidden-colours__tile.owner-0{background:#352326}.hidden-colours__tile.owner-1{background:#202b42}.hidden-colours__colour-dot{width:55%;height:55%;border-radius:50%;background:#e85c58;box-shadow:inset 0 2px 6px rgba(255,255,255,.45),0 3px 10px rgba(0,0,0,.35)}.hidden-colours__tile.owner-1 .hidden-colours__colour-dot{background:#5a91f2}.hidden-colours__tile>span{color:#8f8f99}.hidden-colours__power-icon{font-size:1.4rem!important}.hidden-colours__bottom-buttons{display:flex;gap:10px;flex-shrink:0}.hidden-colours__bottom-buttons button{flex:1;padding:10px 16px;border-radius:999px;background:#23232a;border:1px solid #35353f;color:white;font:600 .85rem Inter,var(--font-body),sans-serif;cursor:pointer;box-shadow:none}.hidden-colours__bottom-buttons button:hover{background:#2d2d36;transform:translateY(-1px)}.hidden-colours__sidebar{display:flex;flex-direction:column;gap:12px;overflow-y:auto}.hidden-colours__sidebar h3{margin:0;font-size:.7rem;letter-spacing:.12em;text-transform:uppercase;color:#6d6d77}.hidden-colours__players-panel{display:flex;flex-direction:column;gap:8px}.hidden-colours__player-box{display:flex;flex-direction:column;align-items:flex-start;padding:12px;border-radius:14px;background:#222228;border:1px solid #303038;transition:.25s}.hidden-colours__player-box.is-active{border:2px solid #d8b865;box-shadow:0 0 20px rgba(216,184,101,.25)}.hidden-colours__player-dot{width:8px;height:8px;border-radius:50%;margin-bottom:6px}.hidden-colours__player-box strong{font-size:.8rem;word-break:break-word}.hidden-colours__player-box b{margin-top:auto;color:#e6c467;font-size:1.6rem}.hidden-colours__player-box small{color:#8f8f99;font-size:.65rem}.hidden-colours__turn-card{display:flex;align-items:center;justify-content:center;gap:6px;padding:10px;border-radius:14px;background:#202026;border:1px solid #313139;font-size:.85rem;text-align:center}.hidden-colours__turn-card i{width:8px;height:8px;flex:0 0 auto;border-radius:50%;background:#f0c85d;box-shadow:0 0 10px #f0c85d;animation:hidden-colours-pulse 1s infinite}.hidden-colours__power-panel{padding:14px;background:#202026;border-radius:14px;border:1px solid #313139;flex-shrink:0}.hidden-colours__power-panel p{margin:0 0 10px;font-size:.7rem;letter-spacing:.1em;text-transform:uppercase;color:#6d6d77}.hidden-colours__power-panel span{display:block;margin-bottom:6px;padding:6px 10px;background:#282830;border-radius:10px;font-size:.8rem}.hidden-colours__power-panel span:last-child{margin-bottom:0}.hidden-colours--welcome{padding:20px}.hidden-colours__welcome-card{width:min(100%,620px);padding:clamp(30px,6vw,64px);border:1px solid #2d2d35;border-radius:34px;background:#17171c;text-align:center;box-shadow:0 30px 60px rgba(0,0,0,.45)}.hidden-colours__welcome-card>span{font-size:4rem}.hidden-colours__welcome-card h1{margin:12px 0;color:#f0c85d;font-size:clamp(2.2rem,5vw,4rem)}.hidden-colours__welcome-card p{color:#a2a2ac;line-height:1.6}.hidden-colours__name-fields{display:grid;grid-template-columns:1fr 1fr;gap:14px;margin:28px 0}.hidden-colours__name-fields label{color:#8f8f99;font-size:.78rem;text-align:left}.hidden-colours__name-fields input{width:100%;margin-top:7px;padding:13px;border:1px solid #35353f;border-radius:12px;background:#23232a;color:#fff;font:inherit}.hidden-colours__play{padding:15px 28px;border:0;border-radius:999px;background:linear-gradient(90deg,#e6c467,#ffd87d);color:#29200f;font:800 1rem Inter,var(--font-body),sans-serif;cursor:pointer}@keyframes hidden-colours-pulse{50%{transform:scale(1.25);opacity:.6}}@media(max-width:900px){.hidden-colours__shell{grid-template-columns:1fr;gap:14px;height:auto}.hidden-colours__sidebar{width:100%;flex-direction:row;flex-wrap:wrap;order:-1;gap:10px}.hidden-colours__grid{gap:8px}.hidden-colours__tile{font-size:1.2rem;border-radius:12px}.hidden-colours__bottom-buttons button{font-size:.8rem;padding:8px 12px}}@media(max-width:720px){.hidden-colours{padding:4px}.hidden-colours__shell{padding:8px;gap:8px;border-radius:16px}.hidden-colours__grid{gap:6px}.hidden-colours__tile{border-radius:10px;font-size:1rem}.hidden-colours__bottom-buttons button{padding:6px 10px;font-size:.75rem}.hidden-colours__name-fields{grid-template-columns:1fr}}
`;
