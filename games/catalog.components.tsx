...
export const GAME_COMPONENTS: Partial<Record<string, React.LazyExoticComponent<React.ComponentType<any>>>> = {
  bowlingbattle: lazyGame('bowlingbattle', () => import('@/games/bowling-battle/BowlingBattle.jsx')),
  ...
  superwings: lazyGame('superwings', () => import('@/games/super-wings/SuperWings.jsx')),
  swampjump: lazyGame('swampjump', () => import('@/games/swamp-jump/FroggyHop.jsx')),
  treasurechest: lazyGame('treasurechest', () => import('@/games/treasure-chest/TreasureChest.jsx')),
  unicornwings: lazyGame('unicornwings', () => import('@/games/unicorn-wings/UnicornWings.jsx')),
  ...
  higherorlower: lazyGame('higherorlower', () => import('@/games/higher-or-lower/HigherOrLower.jsx')),
  picturerace: lazyGame('picturerace', () => import('@/games/picture-race/PictureRace.jsx')),
  redorblack: lazyGame('redorblack', () => import('@/games/red-or-black/RedOrBlack.jsx')),
  ...
  whatsmissing: lazyGame('whatsmissing', () => import('@/games/whats-missing/WhatsMissing.jsx')),
};
