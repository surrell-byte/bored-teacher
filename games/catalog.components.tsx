...
export const GAME_COMPONENTS: Partial<Record<string, React.LazyExoticComponent<React.ComponentType<any>>>> = {
  ...
  phonicsworld: lazy(() => import('@/games/phonics-world/PhonicsWorld.jsx')),
  ...
  sentencebuilder: lazy(() => import('@/games/sentence-builder/SentenceBuilder.jsx')),
  tankwars: lazy(() => import('@/games/tank-wars/TankWars.jsx')),
  zoogame: lazy(() => import('@/games/zoo-game/ZooGame.jsx')),
  whatami: lazy(() => import('@/games/what-am-i/WhatAmI.jsx')),
