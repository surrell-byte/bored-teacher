...
@media (max-width: 639px) { .riddle-bombs { min-height: 100dvh; width: 100%; padding: 10px; }.rb-welcome,.rb-menu { min-height: calc(100dvh - 20px); padding: 20px 10px; }.rb-bomb { font-size: 4.5rem; }.rb-game { min-height: calc(100dvh - 20px); }.rb-bomb-panel { padding: 12px; }.rb-bomb-large { width: min(190px, 58vw); height: min(190px, 58vw); font-size: 4rem; }.rb-question-panel { padding: 16px; } }
`;
