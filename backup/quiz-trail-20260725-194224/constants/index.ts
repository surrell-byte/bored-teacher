...
export const GAME_KEYS = [
  ...
  'pacman','phonicsadventure','phonicsworld','shuttlecock','tornado','wgrandprix',
...
export const GAME_NAMES: Record<string, string> = {
  ...
  tornado: 'Tornado', wgrandprix: 'W Grand Prix',
  countadd: 'Count & Add', 
...
export const GAME_ICONS: Record<string, string> = {
  unicorn: '🦄', warriors: '🏀', compound: '🧩',
  wordmatch: '🔤', memory: '🧠', missingfruit: '🍓',
  animalclass: '🦁', colourclash: '🎨',
...
export const GAME_BADGE: Record<string, string> = {
  ...
  shuttlecock: 'Smash', tornado: 'Storm', wgrandprix: 'Race',
...
export const GAME_DIFFICULTY: Record<string, string> = {
  ...
  shuttlecock: 'Competitive', tornado: 'Intermediate', wgrandprix: 'Competitive',
...
export const GAME_BAR_COLOR: Record<string, string> = {
  ...
  shuttlecock: 'var(--green)', tornado: 'var(--red)', wgrandprix: 'var(--red)',
